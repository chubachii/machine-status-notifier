...
from easy_yolov7.utils.general import check_img_size, non_max_suppression, scale_coords, crop
from easy_yolov7.models.experimental import attempt_load
from easy_yolov7.utils.torch_utils import select_device
from easy_yolov7.utils.detections import Detections
from easy_yolov7.utils.datasets import letterbox
from easy_yolov7.byte_tracker import BYTETracker
import numpy as np
import torch
import yaml
...
class YOLOv7:
    def __init__(self, conf_thres=0.25, iou_thres=0.45, img_size=480, ocr_classes=[]):
        self.settings = {
